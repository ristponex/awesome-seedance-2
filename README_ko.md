...
> **참고:** 글로벌 API 출시는 지연되고 있지만, [Atlas Cloud](https://www.atlascloud.ai?ref=JPM683)에서 **Seedance v1.5 Pro**를 $0.044/초부터로 지금 바로 사용할 수 있습니다.
...
> **팁:** Seedance 2.0 글로벌 API를 기다리는 동안 [Atlas Cloud](https://www.atlascloud.ai?ref=JPM683)에서 **Seedance v1.5 Pro**를 **$0.044/초부터**로 지금 바로 이용하세요.
